    ...
    def forward(
        ...
        if joint_attention_kwargs['use_cache']:
            ...
            if current['type'] == 'full': # Force Activation: Compute all tokens and save them in cache
                ...
                current['module'] = 'norm'
                fresh_indices, fresh_tokens = predefine_cache_cutfresh(cache_dic, hidden_states, current)
    ...
    def forward(
        ...
        if joint_attention_kwargs['use_cache']:
            ...
            if current['type'] == 'full':
                ...
                current['module'] = 'cross-mlp'
                fresh_indices, fresh_tokens = predefine_cache_cutfresh(cache_dic, encoder_hidden_states, current)
