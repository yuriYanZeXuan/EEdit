...
class FluxFillPipeline(
    ...
    def controlled_forward_ode(self,
        ...
        if timesteps.shape[0] == 1:
            ...
            raise ValueError(f"timesteps.shape: {timesteps.shape}, sigmas.shape: {sigmas.shape}")
    ...
    def __call__(
        ...
        Args:
            ...
            use_rf_inversion (`bool`, *optional*, defaults to `True`): Whether to use the controlled forward ODE
                inversion for the denoising process.
            eta (`float`, *optional*, defaults to 1.0): The eta parameter for the controlled forward ODE inversion.
            gamma (`float`, *optional*, defaults to 1.0): The gamma parameter for the controlled forward ODE inversion.
            start_timestep (`int`, *optional*, defaults to 0): The starting timestep for the controlled forward ODE
                inversion.
            stop_timestep (`int`, *optional*, defaults to 4): The stopping timestep for the controlled forward ODE
                inversion.
            mask_timestep (`int`, *optional*, defaults to 18): The timestep at which the mask is applied during the
                denoising process.
            skip_T (`int`, *optional*, defaults to 1): The number of steps to skip for the controlled forward ODE
                inversion.
            skip_T_fwd (`int`, *optional*, defaults to 1): The number of steps to skip for the controlled forward ODE
                denoising loop.
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if i % skip_T_fwd == 0 or i == len(timesteps) - 1:
                    t_i = 1 - t / 1000
                    if self.interrupt:
                        continue
